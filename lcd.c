...
//I made changes here - you had D7, D5, D3, D1 
#define LCD_DATA4 LATEbits.LATE7 //D7 - RE7
#define LCD_DATA5 LATEbits.LATE5 //D6 - RE5
#define LCD_DATA6 LATEbits.LATE3 //D5 - RE3
#define LCD_DATA7 LATEbits.LATE1 //D4 - RE1


//I made changes here - you had them backwards 
...
void writeFourBits(unsigned char word, unsigned int commandType, unsigned int delayAfter, unsigned int lower)
{
    ...
    {
        LCD_DATA7 = word & 0x01;
        LCD_DATA5 = (word & 0x02) >> 1;
        LCD_DATA3 = (word & 0x04) >> 2;
        LCD_DATA1 = (word & 0x08) >> 3;
    }
    
    else if (lower == 0) //upper
    {
        LCD_DATA7 = (word & 0x10) >> 4;
        LCD_DATA5 = (word & 0x20) >> 5;
        LCD_DATA3 = (word & 0x40) >> 6;
        LCD_DATA1 = (word & 0x80) >> 7;
    }
